...
import { ObjModelViewer } from "@/components/project/obj-model-viewer";
...
export function EphemeraLayout({
  project,
  relatedProjects,
  allProjects,
  ...
  const conceptVideoItems = conceptAssets.mediaItems.filter((item) => item.kind === "video");
  ...
  const theProjectImageItems = theProjectAssets.mediaItems.filter((item) => item.kind === "image");
  ...
  return (
    <main className="relative project-glass ephemera-theme bg-black">
      <div aria-hidden className="pointer-events-none fixed inset-0 z-0 bg-black" />

      <div className="relative z-[1]">
        <div className="ephemera-dark">
          {/* ── Hero ── */}
          <Section
              ...
              {conceptAssets.mediaItems.length > 0 ? (
                <div className="space-y-8">
                  <FadeGroup {...PROJECT_FADE_VIEWPORT} className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start">
                    ...
                    {conceptVideoItems.length > 0 && (
                      <FadeIn {...PROJECT_FADE_VIEWPORT} delay={TITLE_MEDIA_DELAY}>
                        {renderMediaColumn("concept", conceptVideoItems)}
                      </FadeIn>
                    )}
                  </FadeGroup>
            ...
            <Section className="border-t border-[#d7dbe2] pt-10 pb-14">
              <div className="space-y-10">
                <FadeGroup {...PROJECT_FADE_VIEWPORT} className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-stretch">
                  ...
                  <FadeIn {...PROJECT_FADE_VIEWPORT} delay={TITLE_MEDIA_DELAY} className="min-h-[320px]">
                    <ObjModelViewer url={encodeURI(resolveAssetUrl("ephemera-of-existence/overview/Ephemeral of Existence 3D.obj"))} />
                  </FadeIn>
                </FadeGroup>
